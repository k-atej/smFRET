...
class StackedTrajectoryMaker():
    ...
    def __init__(self, all_data, master, title):
        ...
        self.fig.suptitle(self.title, y = 0.93, x=0.57, fontsize=12)
    ...
    def makeIntensity(self):
        ...
        self.fig.text(0.1, 0.5, "Intensity (AU)", ha="left", va="center", rotation="vertical", fontsize=12)
    ...
    def makeEfficiency(self):
        ...
        self.fig.text(0.525, 0.5, "FRET Efficiency", ha="left", va="center", rotation="vertical", fontsize=12)
